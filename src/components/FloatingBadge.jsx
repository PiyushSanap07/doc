...
const FloatingBadge = ({ icon: Icon, title, subtitle, className = "" }) => {
  return (
    <div className={`bg-white rounded-xl p-3 px-4 border-2 border-navy shadow-[3px_3px_0px_#123B53] flex items-center gap-3 transition-all duration-300 hover:-translate-y-1 ${className}`}>
      {Icon && (
